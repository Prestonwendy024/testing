    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50">
        <div className="bg-white rounded-lg shadow-lg p-8 text-center">
          ...
          <h2 className="text-xl font-bold text-gray-900 mb-2">Deposit Successful!</h2>
          <p className="text-gray-600">The deposit has been processed successfully.</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="max-w-lg mx-auto bg-white rounded-lg shadow-lg p-8">
        <h1 className="text-xl font-semibold text-gray-800 mb-4">Online Deposit (Admin)</h1>
